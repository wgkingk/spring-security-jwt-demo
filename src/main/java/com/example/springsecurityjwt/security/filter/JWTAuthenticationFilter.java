...
import com.example.springsecurityjwt.security.constants.SecurityConstants;
import com.example.springsecurityjwt.security.entity.JwtUserDetails;
import com.example.springsecurityjwt.security.utils.JwtTokenUtils;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        try {
            // 从输入流中获取到登录的信息
            JwtUserDetails loginUser = objectMapper.readValue(request.getInputStream(), JwtUserDetails.class);
            rememberMe.set(true);
